...
INSERT INTO `tbl_alarm` (`alarm_id`, `alarm_detail`, `alarm_date`, `member_id`, `participation_id`,
                         `alarm_status`, `alarm_checked`)
VALUES (1, '참가신청', '2023-07-01 12:00:00', 1, 1, '승인대기', true),
